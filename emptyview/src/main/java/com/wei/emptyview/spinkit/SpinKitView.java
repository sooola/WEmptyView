...
public class SpinKitView extends ProgressBar {
    ...
    public SpinKitView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SpinKitView, defStyleAttr,
                defStyleRes);
        mStyle = com.wei.emptyview.spinkit.Style.values()[a.getInt(R.styleable.SpinKitView_SpinKit_Style, 0)];
    ...
    private void init() {
        Sprite sprite = com.wei.emptyview.spinkit.SpriteFactory.create(mStyle);
